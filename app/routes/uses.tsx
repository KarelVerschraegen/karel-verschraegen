...
const Uses = () => {
	return (
		<div className="flex flex-col gap-16">
			...
			<section id="uses">
				<Grid className="grid-cols-1 gap-16 md:grid-cols-4">
					<Grid.Item>
						...
						<ul className="flex flex-col gap-16">
							<li>
								<div className="prose prose-slate">
									...
									<Text>
										I have always been interested in electronics and building my own computer. In
										July 2019, I built my own PC with the following specs:
									</Text>
						...
						<ul className="flex flex-col gap-16">
							...
							<li>
								<div className="prose prose-slate">
									...
									<Text>
										As someone struggling with subarticular disc bulging on L3 - L5, having a proper
										desk setup and chair is a must
									</Text>
								</div>
							</li>
						...
						<ul>
							<li>
								<div className="prose prose-slate">
									...
									<Text>
										My preferred editor, with Popping and Locking as theme and Material Icon as icon
										set combined with some extensions to make my development life easier
									</Text>
								</div>
							</li>
						</ul>
